...
class EditParty extends Component {
    ...
    handleSubmit = (e) => {
        ...
        const { uid, fullName, shortName, photoUrl, founded, date, month, year } = this.state;
        const { actionNotification, actionHide } = this.props
        ...
        const partyData = {
            ...
            shortName: shortName,
            photoUrl: photoUrl,
            founded: founded || `${date}/${month}/${year}`
        }

        service.post('/edit-party', partyData)
            .then(res => {
                console.log(res);
                actionHide()
                        ...
                        <div className="col-md-6">
                            <form onSubmit={this.handleSubmit}>
                                <div className="form-group">
                                    ...
                                    <input className="form-control" type="text" name="fullName" value={fullName} onChange={this.handleChange} />
                                </div>

                                <div className="form-group">
                                    <label htmlFor="shortName">Party short Name</label>
                                    <input className="form-control" type="text" name="shortName" value={shortName} onChange={this.handleChange} />
                                </div>
...
export default connect(state => state, mapDispatchToProps)(EditParty)